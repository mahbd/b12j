...
ALLOWED_HOSTS = ['b12j.herokuapp.com', '127.0.0.1', 'b12j-api.herokuapp.com', 'b12j.ga', 'api.b12j.ga', '0.0.0.0']
...
DJOSER = {
    ...
    'USERNAME_RESET_CONFIRM_URL': 'users/emailResetConfirm/{uid}/{token}',
    'PASSWORD_RESET_CONFIRM_URL': 'users/emailResetConfirm/{uid}/{token}',
